          ...
          <div v-if="history.length == 0" class="index">
            ...
            <div class="msg">
              ...
              <el-row class="index-content">
                <el-col :span="8">"Explain quantum computing in simple terms" →</el-col>
                <el-col :span="8">Remembers what user said earlier in the conversation</el-col>
              ...
              <el-row  class="index-content">
                <el-col :span="8">"How do I make an HTTP request in Javascript?" →</el-col>
                <el-col :span="8">Trained to decline inappropriate requests</el-col>
                <el-col :span="8">Trained to decline inappropriate requests</el-col>
              </el-row>
            </div>
          </div>
